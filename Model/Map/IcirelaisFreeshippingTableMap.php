...
class IcirelaisFreeshippingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DpdPickup.Model.Map.IcirelaisFreeshippingTableMap';
     ...
     */
    const OM_CLASS = '\\DpdPickup\\Model\\IcirelaisFreeshipping';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DpdPickup.Model.IcirelaisFreeshipping';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DpdPickup\\Model\\IcirelaisFreeshipping');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DpdPickup\Model\IcirelaisFreeshipping) { // it's a model object
