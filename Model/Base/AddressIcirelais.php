...
use DpdPickup\Model\Thelia\Model\Country as ChildCountry;
use DpdPickup\Model\Thelia\Model\CustomerTitle as ChildCustomerTitle;
use DpdPickup\Model\Thelia\Model\CountryQuery;
use DpdPickup\Model\Thelia\Model\CustomerTitleQuery;
...
abstract class AddressIcirelais implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Initializes internal state of DpdPickup\Model\Base\AddressIcirelais object.
     */
    ...
    /**
     * Compares this with another <code>AddressIcirelais</code> instance.  If
     * <code>obj</code> is an instance of <code>AddressIcirelais</code>, delegates to
     * <code>equals(AddressIcirelais)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setTitleId($v)
    {
        ...
        if ($this->title_id !== $v) {
            $this->title_id = $v;
            $this->modifiedColumns[AddressIcirelaisTableMap::TITLE_ID] = true;
        }
    ...
    public function setCountryId($v)
    {
        ...
        if ($this->country_id !== $v) {
            $this->country_id = $v;
            $this->modifiedColumns[AddressIcirelaisTableMap::COUNTRY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AddressIcirelaisTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AddressIcirelaisTableMap::translateFieldName('TitleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AddressIcirelaisTableMap::translateFieldName('Company', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AddressIcirelaisTableMap::translateFieldName('Firstname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->firstname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AddressIcirelaisTableMap::translateFieldName('Lastname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lastname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AddressIcirelaisTableMap::translateFieldName('Address1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AddressIcirelaisTableMap::translateFieldName('Address2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AddressIcirelaisTableMap::translateFieldName('Address3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AddressIcirelaisTableMap::translateFieldName('Zipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AddressIcirelaisTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AddressIcirelaisTableMap::translateFieldName('CountryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AddressIcirelaisTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 12; // 12 = AddressIcirelaisTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \DpdPickup\Model\AddressIcirelais object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAddressIcirelaisQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @see AddressIcirelais::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildAddressIcirelaisQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AddressIcirelaisTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AddressIcirelaisTableMap::TITLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE_ID';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::COMPANY)) {
            $modifiedColumns[':p' . $index++]  = 'COMPANY';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'FIRSTNAME';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::LASTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'LASTNAME';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS1)) {
            $modifiedColumns[':p' . $index++]  = 'ADDRESS1';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'ADDRESS2';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = 'ADDRESS3';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::ZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = 'ZIPCODE';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::CITY)) {
            $modifiedColumns[':p' . $index++]  = 'CITY';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::COUNTRY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'COUNTRY_ID';
        }
        if ($this->isColumnModified(AddressIcirelaisTableMap::CODE)) {
            $modifiedColumns[':p' . $index++]  = 'CODE';
        }

        $sql = sprintf(
            'INSERT INTO address_icirelais (%s) VALUES (%s)',
    ...
    {
        $pos = AddressIcirelaisTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['AddressIcirelais'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AddressIcirelais'][$this->getPrimaryKey()] = true;
        $keys = AddressIcirelaisTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AddressIcirelaisTableMap::ID)) $criteria->add(AddressIcirelaisTableMap::ID, $this->id);
        if ($this->isColumnModified(AddressIcirelaisTableMap::TITLE_ID)) $criteria->add(AddressIcirelaisTableMap::TITLE_ID, $this->title_id);
        if ($this->isColumnModified(AddressIcirelaisTableMap::COMPANY)) $criteria->add(AddressIcirelaisTableMap::COMPANY, $this->company);
        if ($this->isColumnModified(AddressIcirelaisTableMap::FIRSTNAME)) $criteria->add(AddressIcirelaisTableMap::FIRSTNAME, $this->firstname);
        if ($this->isColumnModified(AddressIcirelaisTableMap::LASTNAME)) $criteria->add(AddressIcirelaisTableMap::LASTNAME, $this->lastname);
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS1)) $criteria->add(AddressIcirelaisTableMap::ADDRESS1, $this->address1);
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS2)) $criteria->add(AddressIcirelaisTableMap::ADDRESS2, $this->address2);
        if ($this->isColumnModified(AddressIcirelaisTableMap::ADDRESS3)) $criteria->add(AddressIcirelaisTableMap::ADDRESS3, $this->address3);
        if ($this->isColumnModified(AddressIcirelaisTableMap::ZIPCODE)) $criteria->add(AddressIcirelaisTableMap::ZIPCODE, $this->zipcode);
    ...
    {
        $criteria = new Criteria(AddressIcirelaisTableMap::DATABASE_NAME);
        $criteria->add(AddressIcirelaisTableMap::ID, $this->id);
    ...
    public function getCustomerTitle(ConnectionInterface $con = null)
    {
        if ($this->aCustomerTitle === null && ($this->title_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCustomerTitle->addAddressIcirelaiss($this);
             */
        }
    ...
    public function getCountry(ConnectionInterface $con = null)
    {
        if ($this->aCountry === null && ($this->country_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCountry->addAddressIcirelaiss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AddressIcirelaisTableMap::DEFAULT_STRING_FORMAT);
    }
