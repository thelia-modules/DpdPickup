...
use DpdPickup\Model\Thelia\Model\OrderAddress as ChildOrderAddress;
use DpdPickup\Model\Thelia\Model\OrderAddressQuery;
...
abstract class OrderAddressIcirelais implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DpdPickup\\Model\\Map\\OrderAddressIcirelaisTableMap';
    ...
    /**
     * Initializes internal state of DpdPickup\Model\Base\OrderAddressIcirelais object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \DpdPickup\Model\OrderAddressIcirelais object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DpdPickup\Model\OrderAddressIcirelais (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DpdPickup\Model\OrderAddressIcirelais Clone of current object.
     * @throws PropelException
     */
