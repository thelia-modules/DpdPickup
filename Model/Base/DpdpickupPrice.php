...
abstract class DpdpickupPrice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DpdPickup\\Model\\Map\\DpdpickupPriceTableMap';
    ...
    /**
     * Compares this with another <code>DpdpickupPrice</code> instance.  If
     * <code>obj</code> is an instance of <code>DpdpickupPrice</code>, delegates to
     * <code>equals(DpdpickupPrice)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return DpdpickupPrice The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DpdpickupPriceTableMap::ID] = true;
        }
    ...
    public function setAreaId($v)
    {
        ...
        if ($this->area_id !== $v) {
            $this->area_id = $v;
            $this->modifiedColumns[DpdpickupPriceTableMap::AREA_ID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[DpdpickupPriceTableMap::PRICE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[DpdpickupPriceTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[DpdpickupPriceTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DpdpickupPriceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DpdpickupPriceTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DpdpickupPriceTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = DpdpickupPriceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \DpdPickup\Model\DpdpickupPrice object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDpdpickupPriceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DpdpickupPrice::setDeleted()
     * @see DpdpickupPrice::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDpdpickupPriceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(DpdpickupPriceTableMap::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(DpdpickupPriceTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DpdpickupPriceTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DpdpickupPriceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DpdpickupPriceTableMap::ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO dpdpickup_price (%s) VALUES (%s)',
    ...
    {
        $pos = DpdpickupPriceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DpdpickupPrice'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DpdpickupPrice'][$this->getPrimaryKey()] = true;
        $keys = DpdpickupPriceTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(DpdpickupPriceTableMap::DATABASE_NAME);
        $criteria->add(DpdpickupPriceTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DpdPickup\Model\DpdpickupPrice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DpdPickup\Model\DpdpickupPrice Clone of current object.
     * @throws PropelException
     */
    ...
    public function getArea(ConnectionInterface $con = null)
    {
        if ($this->aArea === null && ($this->area_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArea->addDpdpickupPrices($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DpdpickupPriceTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     ChildDpdpickupPrice The current object (for fluent API support)
     */
